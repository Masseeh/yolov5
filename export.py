...
def export_tflite(keras_model, im, file, int8, data, ncalib, prefix=colorstr('TensorFlow Lite:')):
    ...
    try:
        ...
        if int8:
            dataset = LoadImages(data, img_size=imgsz, auto=True)  # representative data
...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default='../../datasets/multi_room/0', help='dataset.yaml path')
    parser.add_argument('--weights', type=str, default=ROOT / 'runs/train/all-rooms/weights/last.pt', help='weights path')
    parser.add_argument('--imgsz', '--img', '--img-size', nargs='+', type=int, default=[24, 32], help='image (h, w)')
